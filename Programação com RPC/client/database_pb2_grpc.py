...
class RequestMiddlewareStub(object):
...
class RequestMiddlewareServicer(object):
    """interface de serviço
    """
...
def add_RequestMiddlewareServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'RequestMiddleware', rpc_method_handlers)
...
class RequestMiddleware(object):
    ...
    def Comunication(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/RequestMiddleware/Comunication',
